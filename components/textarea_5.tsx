...
interface Textarea_5Props extends React.TextareaHTMLAttributes<HTMLTextAreaElement> {
  value: string;
  minWidth?: number;
  enableFormatting?: boolean;
}

export function Textarea_5({ value, className, minWidth = 50, enableFormatting = true, onChange, ...props }: Textarea_5Props) {
